...
<a name="3.4.1"></a>
## [3.4.1](https://github.com/yidinghan/daily-signin/compare/v3.4.0...v3.4.1) (2018-06-05)


### Features

* **flyertea:** use domcontentloaded back and wait 5s every time ([fd7d028](https://github.com/yidinghan/daily-signin/commit/fd7d028))
...
* **flyertea:** refresh home page for checkin result ([c33ce4a](https://github.com/yidinghan/daily-signin/commit/c33ce4a))
...
* **flyertea:** more logger ([3bbc5b1](https://github.com/yidinghan/daily-signin/commit/3bbc5b1))
...
* **readme:** remote waitForNavigation ([1186598](https://github.com/yidinghan/daily-signin/commit/1186598))
